...
python -m da -n MainNode --logfile --logfilename ../logs/main.log --logfilelevel info --message-buffer-size 100000 --hostname $IP_ADDR main.da -c forward_request_operation_change.txt